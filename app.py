...
# Convidado 1
col_conv1a, col_conv1b = st.columns([2, 1])
with col_conv1a:
    nome_conv1 = st.text_input("Nome do convidado 1:", placeholder="Ex: Amigo 1")
with col_conv1b:
    tipo_conv1 = st.selectbox("Cota 1:", ["Ninguém", "Individual (1 cota)", "Casal (2 cotas)"], key="c1")

# Convidado 2
col_conv2a, col_conv2b = st.columns([2, 1])
with col_conv2a:
    nome_conv2 = st.text_input("Nome do convidado 2:", placeholder="Ex: Amigo 2")
with col_conv2b:
    tipo_conv2 = st.selectbox("Cota 2:", ["Ninguém", "Individual (1 cota)", "Casal (2 cotas)"], key="c2")
...
# Cota Convidados
c1_val = 0
if nome_conv1 and tipo_conv1 != "Ninguém":
    c1_val = 1 if "Individual" in tipo_conv
